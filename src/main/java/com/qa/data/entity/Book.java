...
public class Book {
	...
	@Id
	@Min(999999999)
	private Long isbn; // personal stretch goal: add @pattern annotation and use regexp to confirm is
						// valid isbn
	...
	public Book(@Min(999999999) Long isbn, @NotNull String title, @NotNull String authorSurname, String authorForename,
			int pubYear, @NotNull boolean isDigital, String publisher, String genreCode) {
		super();
		this.isbn = isbn;
		this.title = title;
	...
	public String toString() {
		return "Book: ISBN: " + isbn + ", title :" + title + ", author: " + authorSurname + ", " + authorForename
				+ ", publication year: " + pubYear + ", ebook: " + isDigital + ", publisher: " + publisher
